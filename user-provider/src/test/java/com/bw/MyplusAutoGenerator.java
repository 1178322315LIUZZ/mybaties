...
public class MyplusAutoGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/four?characterEncoding=UTF8&userSSL=false&serverTimezone=GMT%2B8");
        //数据库用户名
        dsc.setUsername("root");
        //数据库密码
        dsc.setPassword("315165");
        ...
        sc.setInclude("user");
		//字段前缀
		//sc.setFieldPrefix("e_ ");
		//表的前缀
		//sc.setTablePrefix("e_ ");
		//注解加上
